...
public class Venta extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final BaseDatos resga = new BaseDatos(getApplicationContext(), "BaseDatos", null, 1);
        ...
        final BaseDatos resg = new BaseDatos(getApplicationContext(), "BaseDatos", null, 1);
        ...
        while (cursortipos.moveToNext()) {
            ...
            btFavorito.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    @SuppressLint("Recycle") Cursor cursor2 = bd2.rawQuery("SELECT  ArticulosVenta.Categorias,ArticulosVenta.Nombre,ArticulosVenta.Numero,ArticulosVenta.Precio,ArticulosVenta.IVA FROM ArticulosVenta INNER JOIN Articulos ON  ArticulosVenta.Nombre = Articulos.Nombre WHERE Articulos.Favorito = '1' ORDER BY ArticulosVenta.Nombre ASC", null);
                    @SuppressLint("Recycle") Cursor cursor3 = bd2.rawQuery("SELECT ArticulosVenta.Categorias,ArticulosVenta.Numero,ArticulosVenta.Precio,ArticulosVenta.IVA FROM ArticulosVenta INNER JOIN Articulos ON  ArticulosVenta.Nombre = Articulos.Nombre WHERE Articulos.Favorito = '1' ", null);
                    @SuppressLint("Recycle") Cursor cursor5 = bd2.rawQuery("SELECT CategoriasTabla.Categoria,Articulos.Nombre,Articulos.Precio,Articulos.Iva FROM Articulos INNER JOIN CategoriasTabla ON CategoriasTabla.id = Articulos.Categorias AND Articulos.Favorito = '1' ORDER BY Nombre ASC", null);
        ...
        verticket.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Fragment fragment = new TicketDeVentaFragment();
                FragmentTransaction ft = getSupportFragmentManager().beginTransaction();
    ...
    public void logout() {
        final BaseDatos resg = new BaseDatos(this, "BDUsuarios", null, 1);
