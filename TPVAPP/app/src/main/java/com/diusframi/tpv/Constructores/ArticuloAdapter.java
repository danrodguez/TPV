...
public class ArticuloAdapter extends RecyclerView.Adapter<ArticuloAdapter.MultiViewHolder> {
    ...
    public ArticuloAdapter(Editararticulo listener, MisarticulosFragment listener2, Context context, ArrayList<Articulo> ArticulosLista) {
