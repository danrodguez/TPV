...
public class MisArqueosFragment extends Fragment implements Arqueoint {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        filtronumeroboton.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        filtrocalendarioboton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        quitarfiltrosboton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
